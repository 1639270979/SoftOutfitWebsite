<template>
	<div id="refunds">
		...
		<div class="refunds-info">
			<p>退款信息</p>
			<p>金额<span>¥{{ items.cost_goods }}</span></p>
			<p>您的款项将于15个工作日内退回原支付卡。</p>
      <p>具体到账时间以银行为准，请耐心等候商家处理。</p>
		</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			confirmFun: function() {
				let obj = {'item_id':this.iid,'type':2,'content':this.content,'picture':this.imgNum};
				if (this.content != '') {
