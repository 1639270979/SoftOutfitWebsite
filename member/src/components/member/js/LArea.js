 ...
 MobileArea.prototype = {
     init: function(params) {
         ...
         if (params.cityVal) {
             this.cityVal=document.querySelector(params.cityVal);
         }
     ...
     bindEvent: function() {
        ...
        _self.getData(function() {
            ...
            //$(_self.trigger).unbind('click').click(popupArea);
        });
     },
     //重置节点个数
     ...
     finish: function(e) {
         ...
         if (this.cityVal) {
            this.cityVal.value= cityCode ? cityCode : '';
         }
