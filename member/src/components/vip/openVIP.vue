<template>
	<div id="openVIP">
		<div class="top">
			...
			<div class="d1"><img src="./image/vip_01.png"></div>
			<p class="p1">开通VIP会员,购物车商品可省<span>¥{{info.save_money}}元</span></p>
		</div>
		<div class="project">
			<div class="d1"><img src="./image/vip_2.png"></div>
			<ul class="list">
				<!--<li>-->
					<!--<img src="./image/vip_3.png">-->
					<!--<p class="p1">商城全场正价商品</p>-->
					<!--<p class="p2">享受 <span>9.3</span> 折优惠</p>-->
				<!--</li>-->
				<li>
					<img src="./image/vip_4.png">
					<p class="p1">商城套装商品</p>
					<p class="p2">享受 <span>9.5</span> 折优惠</p>
				</li>
				<router-link to="/vip/vip_dobut" tag="li">
					<img src="./image/vip_5.png">
					<p class="p1">每个年度享受 <span>2</span> 次</p>
					<p class="p2">免费设计服务<i class="dobut"></i></p>
				</router-link>
				<li>
					<img src="./image/vip_6.png">
					<p class="p1">超出次数的设计服务</p>
					<p class="p2">享受 <span>9</span> 折优惠</p>
				</li>
				<li>
					<img src="./image/vip_19.png">
					<p class="p1">"我家"套餐</p>
					<p class="p2">享受 <span>9</span> 折优惠</p>
				</li>
				<li>
					<img src="./image/vip_20.png">
					<p class="p1">VIP会员专享</p>
					<p class="p2">免费仓储 <span>180</span> 天</p>
				</li>
				<li>
					<img src="./image/vip_7.png">
					<p class="p1">专属VIP会员日</p>
				</li>
				<li>
					<img src="./image/vip_8.png">
					<p class="p1">设计需求优先</p>
				</li>
				<li>
					<img src="./image/vip_9.png">
					<p class="p1">专属VIP会员客服</p>
				</li>
				<li>
					<img src="./image/vip_10.png">
					<p class="p1">专属尊贵标识</p>
				</li>
			</ul>
		</div>
		<div class="bottom-box"></div>
		<div class="bottom-btn" @click="isAgreement = true">快速成为VIP会员</div>
		<div class="popout" v-if="isAgreement">
			<div class="mask">
				<p class="title">VIP会员协议</p>
				...
				<div class="bottom">
					<div class="read">
						...
						我已阅读并同意<span> 《VIP会员协议》 </span>
					</div>
					<div class="btn">
						<span :class="checkedNames.length != 0 ? 'action' : '' " @click="confirmFun">确定，继续开通会员</span>
		...
		methods: {
			...
			confirmFun: function() {
				if (this.checkedNames.length != 0) {
					this.$router.replace({path:'/vip/openVIPInfo'});
				}
			}
		},
		created() {
...
<style lang="less" scoped>
	...
	#openVIP {
		...
		.bottom-btn {
			...
			text-align: center;
			color: #fff;
			background: -webkit-linear-gradient(left, #fa9e3d,#ee7a1f,#e96a12);
		}
		.popout {
			position: fixed;
			top: 0;
